...
public class GameViewManager {
	...
	private Image bildAbschraegungLinks = new Image(
			getClass().getResourceAsStream("resources/tiles/runfun_abschraegung_links.png"), 125, 125, false, false);
	private Image bildErdeOben = new Image(getClass().getResourceAsStream("resources/tiles/runfun_grass_oben.png"), 125,
			125, false, false);
	private Image bildErdeRechts = new Image(getClass().getResourceAsStream("resources/tiles/runfun_grass_rechts.png"),
			125, 125, false, false);
	private Image bildErde = new Image(getClass().getResourceAsStream("resources/tiles/runfun_erde.png"), 125, 125,
			false, false);
	private Image bildPunktRechtsOben = new Image(
			getClass().getResourceAsStream("resources/tiles/runfun_ecke_rechtsoben.png"), 125, 125, false, false);
	private Image bildRutscheUnten = new Image(
			getClass().getResourceAsStream("resources/tiles/runfun_rutsche_unten.png"), 125, 125, false, false);
	private Image bildErdeLinks = new Image(getClass().getResourceAsStream("resources/tiles/runfun_grass_links.png"),
			125, 125, false, false);
	private Image bildZiel = new Image(getClass().getResourceAsStream("resources/tiles/runfun_ziel.png"), 125, 125,
			false, false);
	...
	private void characterRun(String username) {
		if (!zielErreicht) {
			...
			if (isZeitLaeuft()) {
				...
				timer.setText((getZeit() / 100 / 60) + ":" + ((getZeit() / 100) % 60) + "." + (getZeit() % 100) / 10);
